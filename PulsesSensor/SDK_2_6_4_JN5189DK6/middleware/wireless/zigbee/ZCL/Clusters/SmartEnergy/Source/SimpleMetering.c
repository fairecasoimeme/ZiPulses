...
const tsZCL_AttributeDefinition asCLD_SimpleMeteringClusterAttributeDefinitions[] = {
    ...
    ,{E_CLD_SM_ATTR_ID_POWER_FACTOR,                          (E_ZCL_AF_RD|E_ZCL_AF_WR),     E_ZCL_INT8,    (uint32)(&((tsCLD_SimpleMetering*)(0))->i8PowerFactor), 0}
#endif
    ...
    ,{E_CLD_SM_ATTR_ID_UNIT_OF_MEASURE,                       (E_ZCL_AF_RD|E_ZCL_AF_WR),    E_ZCL_ENUM8,    (uint32)(&((tsCLD_SimpleMetering*)(0))->eUnitOfMeasure), 0}

#ifdef CLD_SM_ATTR_MULTIPLIER
    ,{E_CLD_SM_ATTR_ID_MULTIPLIER,                           (E_ZCL_AF_RD|E_ZCL_AF_WR),    E_ZCL_UINT24,    (uint32)(&((tsCLD_SimpleMetering*)(0))->u24Multiplier), 0}
#endif
